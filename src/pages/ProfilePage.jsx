                ...
                <form onSubmit={handlePasswordChange} className="space-y-5">
                  <div>
                    ...
                    <input
                      ...
                      className={`input ${passwordErrors.old_password ? 'border-red-500' : ''}`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`input ${passwordErrors.new_password ? 'border-red-500' : ''}`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`input ${passwordErrors.confirm_password ? 'border-red-500' : ''}`}
