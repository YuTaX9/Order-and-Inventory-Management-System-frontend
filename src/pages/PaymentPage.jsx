...
const PaymentPage = () => {
  ...
  const handleProcessPayment = async () => {
    ...
    try {
      ...
      const orderNumber =
        orderResponse.order_number || orderResponse.order?.order_number;
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto mb-8">
          <div className="flex items-center justify-center">
            ...
            <div className="flex items-center">
              <div className="w-10 h-10 bg-primary-600 rounded-full flex items-center justify-center text-white font-bold animate-pulse">
                3
              </div>
              <span className="ml-2 text-sm font-medium text-gray-900">
                Payment
            ...
            <div className="lg:col-span-2">
              ...
              <div className="mt-6 flex justify-between">
                <button
                  onClick={() =>
                    navigate("/checkout", {
                      state: { address, notes: orderData.notes },
                    })
                  }
