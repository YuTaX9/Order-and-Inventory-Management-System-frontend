      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Dive into your store's performance at a glance. Manage products,
            orders, and inventory effortlessly.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <Link
            ...
            className="relative p-6 rounded-2xl overflow-hidden shadow-xl transform transition-all duration-300 hover:scale-105 group bg-gradient-to-br from-indigo-700 to-teal-500 text-white flex flex-col items-center justify-center text-center"
          >
            <div className="absolute inset-0 bg-black opacity-10 group-hover:opacity-20 transition-opacity duration-300"></div>
            <svg
              className="w-12 h-12 mb-3 z-10"
            ...
            >
              <path
                ...
                strokeLinejoin="round"
                strokeWidth={2}
                d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 6h4"
              />
            </svg>
            <h3 className="text-2xl font-bold mb-1 z-10">Shipping Zones</h3>
            <p className="text-white/90 text-sm z-10">
            ...
            {Object.entries(stats.orders_by_status).map(([status, count]) => (
              ...
              >
                ...
                {stats.total_orders > 0 && (
                  <span
                    className={`px-2.5 py-0.5 rounded-full text-xs font-semibold mt-1 ${statusColors[
                      status
                    ]
                      .replace("text-", "bg-")
