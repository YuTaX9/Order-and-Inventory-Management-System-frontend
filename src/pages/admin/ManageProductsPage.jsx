...
const ManageProductsPage = () => {
  ...
  const handleInitialDelete = (productId, productName) => {
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4">
                  ...
                  <tr key={product.id} className="hover:bg-gray-50 transition">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center space-x-3">
                        ...
                        <button
                          onClick={() =>
                            handleInitialDelete(product.id, product.name)
                          }
        ...
        <ConfirmModal
            ...
            title={`Confirm Deletion of ${confirmDelete?.name || 'Product'}`}
            message={`Are you sure you want to permanently delete the product "${confirmDelete?.name}" (SKU: ${products.find(p => p.id === confirmDelete?.id)?.sku || 'N/A'})? This action cannot be undone.`}
